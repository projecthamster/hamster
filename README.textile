...
Debian-based: @apt-get install git-core gettext intltool python-gconf python-requests python-beaker@
RPM-based: @yum install git-core gettext intltool gnome-python2-gconf python-requests python-beaker@
...
pre. $ gconftool-2 --set "/apps/hamster-time-tracker/last_activities_days" --type int "7"

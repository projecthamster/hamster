...
Note: the old hamster.lib.dbus linking to hamster.dbus.utilities
      will be removed eventually.
      It stays there only for backward compatibility
      (since python3 does not allow module aliases with "from" imports).
      hamster.dbus.utilities is the new one in the post v3.0 master.
"""
